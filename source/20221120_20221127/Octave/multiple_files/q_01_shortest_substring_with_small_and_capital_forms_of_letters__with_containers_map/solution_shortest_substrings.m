  ...
  for s_length = 2:numel(A)
    for s_index_start = 1 : ( numel(A) - s_length + 1 )
      ...
      for kk_item = 1:numel(temp_set)
        if ( ( mp_small.isKey( temp_set{kk_item} ) ) ...
             && ...
             ( temp_hash.isKey( mp_small( temp_set{kk_item} ) ) ) ) ...
           || ...
           ( ( mp_cap.  isKey( temp_set{kk_item} ) ) ...
             && ...
             ( temp_hash.isKey( mp_cap  ( temp_set{kk_item} ) ) ) )
          %{
